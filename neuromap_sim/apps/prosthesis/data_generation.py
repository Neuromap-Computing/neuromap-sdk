...
from neuromap_sim.apps.prosthesis.config import GammatoneFeatureConfig, ProsthesisDatasetConfig
from neuromap_sim.apps.prosthesis.features import extract_gammatone_features, save_feature_tensor
...
def _infer_noise_type(noise_path: Path, noise_label_map: dict[str, str]) -> str:
    ...
    # staged UrbanSound8K files are prefixed with fold name (e.g. fold1_123-4-0-1.wav)
    if "_" in filename:
...
def _assign_splits(
    ...
    *,
    ...
    # Fallback to item-level split for small-group datasets.
